...
class ImpressionAuditLogUserService extends FPDF
{
     ...
     */
    public function impressionAuditLogUser(User $user, array $auditLogs, ?DateTime $dateDebut = null, ?DateTime $dateFin = null): PaginationPaysage
    {
        ...
        $pdf->Cell(0, 5, 'AUDIT DE : ', 0, 1, 'C', 0);
        $pdf->Cell(0, 5,  $user->getNom(), 0, 1, 'C', 0);
        $pdf->Cell(0, 10, $user->getContact(), 0, 1, 'C', 0);
    ...
    public function enteteTableau(PaginationPaysage $pdf): PaginationPaysage
    {
        ...
        $pdf->Cell(90, 7, utf8_decode('Action'), 1, 0, 'C', true);
        $pdf->Cell(90, 7, utf8_decode('Date et heure'), 1, 1, 'C', true);
    ...
    public function contenuTableau(PaginationPaysage $pdf, int $i, AuditLog $auditLog): PaginationPaysage
    {
        ...
        $pdf->Cell(90, 7, utf8_decode($auditLog->getActionLog()->getActionLog()), 1, 0, 'C', true);
        $pdf->Cell(90, 7, utf8_decode(date_format($auditLog->getDateActionAt(), 'd/m/Y')." - ".date_format($auditLog->getDateActionAt(), 'H:i:s')), 1, 1, 'C', true);
